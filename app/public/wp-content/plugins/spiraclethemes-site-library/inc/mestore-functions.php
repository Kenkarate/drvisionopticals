 ...
 * Add CSS.
 */
if ( ! function_exists( 'spiraclethemes_site_library_mestore_dynamic_css' ) ) :
function spiraclethemes_site_library_mestore_dynamic_css() {
	?>
  		<style type="text/css" id="mestore-admin-style">
...
add_action( 'admin_head', 'spiraclethemes_site_library_mestore_dynamic_css' );